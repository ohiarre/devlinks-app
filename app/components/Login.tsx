    ...
    <div className="w-[375px] md:w-[476px] h-[812px] mx-auto p-4 md:p-8 flex flex-col justify-start items-start gap-8 md:gap-16 bg-white">
      ...
      <form className='flex flex-col'>
        <div className='pb-[40px] space-y-3'>
          <h1 className='font-bold text-xl md:text-2xl text-[#333333]'>Login</h1>
          <p className='font-normal text-base text-[#737373] break-words'>Add your details below to get back into the app</p>
        </div>
        ...
        <div className='pb-[24px]'>
          <label className='font-normal text-xs md:text-sm text-[#333333]'>Password</label>
          <div className='flex items-center w-[311px] md:w-[396px] h-12 border border-[#D9D9D9] rounded-md'>
            <Image
        ...
        <div className=" text-center">
          <h2 className="text-gray-500 text-base font-normal leading-6">Don’t have an account?<br/></h2>
          <Link href="/" className="text-purple-700 text-base font-normal leading-6">Create account</Link>
        </div>
      </form>
    </div>
    </div>
